...
//    shuffle($spewCode);
    ...
    foreach ($spewCode as $img) {
        echo '<div class="content-box">';
//        echo '<h2 class="titel">' . getTitel() .'</h2>';
        echo '<img class="content-img" src="' . url('/img/') . imgSpewer($img) . ' " alt="img">';
//        echo '<p class="content-p">' . getInfo() .'</p>';
//        echo '<p id=\'tag\' class="tag-1">Tag 1: ' . getTag1() . '</p>';
//        echo '<p id=\'tag\' class="tag-2">Tag 2: ' . getTag2() . '</p>';
//        echo '<p id=\'tag\' class="tag-3">Tag 3: ' . getTag3() . '</p>';
        echo '</div>';
    }
}
?>